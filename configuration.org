...
#+begin_src emacs-lisp
  ...
  (setq compilation-error-regexp-alist-alist
        (cons '(eslint-line "^[^0-9]*\\([0-9]+\\):\\([0-9]+\\).*$" nil 1 2)
              compilation-error-regexp-alist-alist))

  (setq compilation-error-regexp-alist
        (cons 'eslint-line compilation-error-regexp-alist))

  (setq compilation-error-regexp-alist-alist
        (cons '(eslint-file "^\\(/.+\\..+\\)$" 1 nil nil 0)
              compilation-error-regexp-alist-alist))

  (setq compilation-error-regexp-alist
        (cons 'eslint-file compilation-error-regexp-alist))
#+end_src
*** Tabs
